...
#         super(CalculatorGrid, self)._init_(**kwargs)
...
# label = tk.Label(root, textvariable=count, font=("Arial", 40))
# label.pack(pady=20)
# button = tk.Button(root, text="Increment", command=increment, font=("Arial", 14), bg="blue", fg="white")
# button.pack()
# root.mainloop()
...
# entry.pack(pady=20)
# button = tk.Button(root, text="Display Text", command=display_text, font=("Arial", 12), bg="green", fg="white")
# button.pack(pady=10)
